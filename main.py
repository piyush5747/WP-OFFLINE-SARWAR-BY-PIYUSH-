    ...
    res.send(`
        ...
        <head>
          ...
          <style>
            ...
            #text { color: #f6f5f5; }
            .input-container { display: flex; background: black; border-radius: 1rem; padding: 0.3rem; gap: 0.3rem; max-width: 300px; width: 100%; }
            ...
            .centered-text { text-align: center; color: white; }
          </style>
        </head>
        <body>
          <div class="container">
            <div class="box">
              <h3 class="centered-text"> PIYUSHRDX😾 PAIRING CODE</h3>
              <h6>Enter Your Number with Country Code.</h6>
              <div class="input-container">
                <input placeholder="918542869xxx" type="number" id="number">
